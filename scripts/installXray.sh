...
install(){
    ...
    case $(uname) in
        Darwin)
            url="https://source711.oss-cn-shanghai.aliyuncs.com/xray/1.2.4/Xray-macos-64.zip"
            zipfile=${url##*/}
            ;;
        Linux)
            url="https://source711.oss-cn-shanghai.aliyuncs.com/xray/1.2.4/Xray-linux-64.zip"
            zipfile=${url##*/}
            ;;
    esac
    ...
    if [ $(uname -m) == "aarch64" ];then
        url="https://source711.oss-cn-shanghai.aliyuncs.com/xray/1.2.4/Xray-linux-arm64-v8a.zip"
        zipfile=${url##*/}
    fi
